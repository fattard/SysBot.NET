...
public class TrainerIdResetterBot9LZA(PokeBotState Config) : PokeRoutineExecutor9LZA(Config)
{
    Dictionary<string, IReadOnlyList<long>> MyStatusPointerDic = new Dictionary<string, IReadOnlyList<long>>
    {
        { "1.0.1", [0x5F0B250, 0xA0, 0x40] },
        { "1.0.2", [0x5F0C250, 0xA0, 0x40] },
        { "1.0.3", [0x5F0E250, 0xA0, 0x40] },
    };
    ...
    public override async Task MainLoop(CancellationToken token)
    {
        ...
        try
        {
            ...
            while (!token.IsCancellationRequested && !foundPattern)
            {
                ...
                if (title != PokeDataOffsetsLZA.LegendsZAID)
